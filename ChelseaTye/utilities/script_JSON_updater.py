...
def update_song_database(database_file, new_songs_file):
    ...
    if 'title' in new_song:
        ...
        print(f"The song in the new_songs file doesn't have a 'title' field: {new_song}")
...
new_song = r'ChelseaTye\utilities\lyrics_songExport.json'
song_total = r'ChelseaTye\utilities\lyrics_library.json'
