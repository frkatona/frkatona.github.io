...
/** @type {string} */
const CACHE_VERSION = '1750359299|13414978074';
/** @type {string} */
const CACHE_PREFIX = '2025-06-19_Terra-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'TerrainWebGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["TerrainWebGame.html","TerrainWebGame.js","TerrainWebGame.offline.html","TerrainWebGame.icon.png","TerrainWebGame.apple-touch-icon.png","TerrainWebGame.audio.worklet.js","TerrainWebGame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["TerrainWebGame.wasm","TerrainWebGame.pck","TerrainWebGame.side.wasm","libterrain.web.debug.wasm32.wasm"];
